...
public class UserController {
	...
	public ResponseEntity<Response<User>> create(HttpServletRequest request, @RequestBody User user,
		...
		try {
			...
			response.getErrors().add("E-mail j� registrado!");
			return ResponseEntity.badRequest().body(response);
		} catch (Exception e) {
	...
	private void validateCreateUser(User user, BindingResult result) {
		if(user.getEmail() == null) {
			result.addError(new ObjectError("Usu�rio", "Email sem informa��o"));
		}
	}
	...
	private void validateUpdateUser(User user, BindingResult result) {
		if(user.getId() == null) {
			result.addError(new ObjectError("User", "Id sem informa��o"));
		}
		if(user.getEmail() == null) {
			result.addError(new ObjectError("User", "Email sem informa��o"));
		}
	}
